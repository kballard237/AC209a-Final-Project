...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{read\PYZus{}txt}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
            \PY{n}{save\PYZus{}ls} \PY{o}{=} \PY{p}{[}\PY{p}{]}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{file}\PY{p}{:}
                \PY{k}{for} \PY{n}{line} \PY{o+ow}{in} \PY{n}{file}\PY{p}{:}
                    ...
                    \PY{k}{for} \PY{n}{val} \PY{o+ow}{in} \PY{n}{line}\PY{p}{:}
                        \PY{n}{save\PYZus{}ls}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{val}\PY{p}{)}
            \PY{k}{return} \PY{n}{save\PYZus{}ls}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{hum} \PY{o}{=} \PY{n}{read\PYZus{}txt}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{CS109a\PYZus{}humidity.txt}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{light} \PY{o}{=} \PY{n}{read\PYZus{}txt}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{CS109a\PYZus{}light.txt}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{motion} \PY{o}{=} \PY{n}{read\PYZus{}txt}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{CS109a\PYZus{}motion.txt}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{pressure} \PY{o}{=} \PY{n}{read\PYZus{}txt}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{CS109a\PYZus{}pressure.txt}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{temp} \PY{o}{=} \PY{n}{read\PYZus{}txt}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{CS109a\PYZus{}temperature.txt}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}78}]:} \PY{c+c1}{\PYZsh{} generate times}
         \PY{n}{oct23} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{datetime}\PY{p}{(}\PY{l+m+mi}{2019}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{,} \PY{l+m+mi}{23}\PY{p}{,} \PY{n}{hour}\PY{o}{=}\PY{l+m+mi}{8}\PY{p}{,} \PY{n}{minute}\PY{o}{=}\PY{l+m+mi}{16}\PY{p}{)}
         \PY{n}{dates} \PY{o}{=} \PY{p}{[}\PY{n}{oct23}\PY{p}{]}
         \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{73}\PY{p}{)}\PY{p}{:} 
             \PY{n}{dates}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{dates}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{+} \PY{n}{datetime}\PY{o}{.}\PY{n}{timedelta}\PY{p}{(}\PY{n}{minutes}\PY{o}{=}\PY{l+m+mi}{30}\PY{p}{)}\PY{p}{)}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}80}]:} \PY{n}{df} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{dates}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{temp}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{temp}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{hum}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{hum}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{press}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{pressure}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{light}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{light}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{motion}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{motion}\PY{p}{\PYZcb{}}\PY{p}{)}
         \PY{n}{df}\PY{o}{.}\PY{n}{drop}\PY{p}{(}\PY{n}{df}\PY{o}{.}\PY{n}{tail}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{.}\PY{n}{index}\PY{p}{,}\PY{n}{inplace}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}81}]:} \PY{n}{df}
\end{Verbatim}
